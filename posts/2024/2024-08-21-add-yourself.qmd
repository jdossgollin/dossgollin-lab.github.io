---
title: "How to Add Yourself to the Lab Website: A Comprehensive Guide"
...
We'll use GitHub's fork and pull request workflow.
...
2. **GitHub**: A web-based platform that hosts Git repositories and facilitates collaboration.
3. **Quarto**: An open-source scientific and technical publishing system built on Pandoc.
...
4. Install a code editor (we recommend [Visual Studio Code](https://code.visualstudio.com/)).
5. Have a command line interface available (Terminal on macOS/Linux, Command Prompt or PowerShell on Windows).
...
1. In VS Code, navigate to the appropriate subfolder within the `people` folder (e.g., `people/grad-students`, `people/undergrads`, etc.).
